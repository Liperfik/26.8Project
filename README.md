...
如果在训练模型的时候，需要测试集进行评分，可以在[songs_normalize.csv](https://github.com/Liperfik/26.8Project/blob/main/songs_normalize.csv)中进一步切分或者自行导入表格
...
项目代码依赖库：[dependency_library.md](https://github.com/Liperfik/26.8Project/blob/main/dependency_library.md)
